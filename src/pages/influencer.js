...
// const Influencer = () => {
//   return (
//     <div className="bg-gradient-to-r from-black via-rose-400 to-black min-h-screen py-24 px-4 sm:px-6 lg:px-8 flex items-center">
...
//           <div className="flex-shrink-0">
//             <div className="relative">
//               <div className="w-52 h-72 sm:w-60 sm:h-80 lg:w-72 lg:h-96 rounded-full overflow-hidden border-4 border-white shadow-2xl">
//                 <img 
//                   src={Sarah}
//                   alt="Sarah"
//                   className="w-full h-full object-cover"
...
//                 <p className="text-gray-200 text-base">December 15, 2025</p>
//               </div>
//             </div>
//           </div>
...
//             <p className="text-gray-100 text-lg sm:text-xl max-w-xl mx-auto lg:mx-0 leading-relaxed">
//               The event features renowned influencers and innovators 
//               shaping trends and driving creativity across various 
//               industries.
//             </p>
...
//             {/* Speaker Info for Desktop */}
//             <div className="hidden lg:flex justify-between items-end max-w-md pt-6">
//               <div>
//                 <h3 className="text-white font-semibold text-lg mb-1">Sarah Johnson</h3>
//                 <p className="text-gray-200 text-sm">December 15, 2025</p>
//               </div>
...
//                 <svg width="40" height="40" viewBox="0 0 24 24" className="text-yellow-400">
//                   <path 
//                     d="M12 2L15.09 8.26L22 9L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9L8.91 8.26L12 2Z" 
//                     stroke="currentColor" 
//                     strokeWidth="2" 
...
//               {/* Name and Date for mobile */}
//               <div className="text-center mt-6 lg:hidden">
//                 <h3 className="text-white font-semibold text-xl">Christopher Wilson</h3>
//                 <p className="text-gray-200 text-base">December 17, 2025</p>
//               </div>
//             </div>
//           </div>
